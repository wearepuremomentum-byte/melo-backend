...
# ============================================
# INIT DEMO TRACKS (GET or POST)
# ============================================

@app.route('/api/init-demo-tracks', methods=['GET', 'POST'])
def init_demo_tracks():
    """Initialize database with demo meditation tracks - Accessible via GET or POST"""
    try:
        ...
        if existing_tracks > 0:
            return jsonify({
                ...
                'message': f'Database already has {existing_tracks} tracks'
            }), 200
        ...
        demo_tracks = [
            ...
            Track(
                ...
                category='sleep',
                duration_minutes=10,
                audio_url='https://example.com/tracks/sleep-10min.mp3',
                description='Quick deep sleep meditation'
            ),
            Track(
                title='30 Min Relaxation',
                category='sleep',
                duration_minutes=30,
                audio_url='https://example.com/tracks/sleep-30min.mp3',
                description='Deep relaxation meditation'
            ),
            Track(
                title='60 Min Sleep Story',
                category='sleep',
                duration_minutes=60,
                audio_url='https://example.com/tracks/sleep-60min.mp3',
                description='Long sleep story meditation'
            ),
            
            # Focus Category
            Track(
                title='20 Min Focus Boost',
                category='focus',
                duration_minutes=20,
                audio_url='https://example.com/tracks/focus-20min.mp3',
            ...
            Track(
                ...
                category='focus',
                duration_minutes=30,
                audio_url='https://example.com/tracks/focus-30min.mp3',
                description='Enter deep work flow state'
            ),
            Track(
                title='45 Min Flow State',
                category='focus',
                duration_minutes=45,
                audio_url='https://example.com/tracks/focus-45min.mp3',
                description='Extended flow state meditation'
            ),
            ...
            Track(
                ...
                category='anxiety',
                duration_minutes=10,
                audio_url='https://example.com/tracks/anxiety-10min.mp3',
                description='Quick anxiety relief'
            ),
            Track(
                title='15 Min Grounding',
                category='anxiety',
                duration_minutes=15,
                audio_url='https://example.com/tracks/anxiety-15min.mp3',
                description='Grounding and centering meditation'
            ),
            Track(
                title='20 Min Peace',
                category='anxiety',
                duration_minutes=20,
                audio_url='https://example.com/tracks/anxiety-20min.mp3',
                description='Inner peace meditation'
            ),
            ...
            Track(
                ...
                category='energy',
                duration_minutes=5,
                audio_url='https://example.com/tracks/energy-5min.mp3',
                description='Quick morning energy boost'
            ),
            Track(
                title='10 Min Energy Flow',
                category='energy',
                duration_minutes=10,
                audio_url='https://example.com/tracks/energy-10min.mp3',
                description='Full body energy activation'
            ),
        ]
        ...
        return jsonify({
            'status': 'success',
            'message': 'Demo tracks successfully initialized',
        ...
        return jsonify({
            'status': 'error',
            'message': 'Failed to initialize demo tracks',
            'error': str(e)
        }), 500
